...
export function Navbar({ className }: { className?: string }) {
  ...
  return (
    <div
      className={cn(
        "fixed  inset-x-0 z-50 flex justify-between items-center px-[120px] border-b border-b-[#00000014]",
        className
      )}
    >
      <Link href="/">
      ...
      <Menu setActive={setActive}>
        ...
        <Link href="/blog" className="text-[#27262BB2] font-semibold text-base">
          Блог
        </Link>
        <Link
          href="/contact"
